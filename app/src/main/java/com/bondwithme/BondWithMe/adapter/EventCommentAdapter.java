...
public class EventCommentAdapter extends RecyclerView.Adapter<EventCommentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch(ece.getSticker_type().trim()) {
                case ".gif":
                    ...
                    try {
                        ...
                        if(gifDrawable != null) {
                            ...
                            String stickerUrl = String.format(Constant.API_STICKER, MainActivity.getUser().getUser_id(), ece.getSticker_name(), stickerGroupPathGig, ece.getSticker_type());
                ...
                case ".png":
                    ...
                    if(ece.getUri() != null) {
                        ...
                        Bitmap bitmap = LocalImageLoader.rotaingImageView(LocalImageLoader.readPictureDegree(ece.getUri().getPath()), ThumbnailUtils.extractThumbnail(BitmapFactory.decodeFile(FileUtil.getRealPathFromURI(mContext, ece.getUri())), 200, 200));
        ...
        if(ece.getFile_id() != null) {//如果有图片id
            ...
            VolleyUtil.initNetworkImageView(mContext, holder.networkImageView, String.format(Constant.API_GET_PIC, "post_preview_m", ece.getUser_id(), ece.getFile_id()), R.drawable.network_image_default, R.drawable.network_image_default);
        }
