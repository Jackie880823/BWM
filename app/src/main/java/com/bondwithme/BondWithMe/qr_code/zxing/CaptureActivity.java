...
import com.bondwithme.BondWithMe.qr_code.zxing.clipboard.ClipboardInterface;
import com.bondwithme.BondWithMe.qr_code.zxing.history.HistoryActivity;
import com.bondwithme.BondWithMe.qr_code.zxing.history.HistoryItem;
import com.bondwithme.BondWithMe.qr_code.zxing.history.HistoryManager;
import com.bondwithme.BondWithMe.qr_code.zxing.result.ResultButtonListener;
import com.bondwithme.BondWithMe.qr_code.zxing.result.ResultHandler;
import com.bondwithme.BondWithMe.qr_code.zxing.result.ResultHandlerFactory;
import com.bondwithme.BondWithMe.qr_code.zxing.result.supplement.SupplementalInfoRetriever;
import com.bondwithme.BondWithMe.qr_code.zxing.share.ShareActivity;
...
//                    Message.obtain(handler, GET_USER_ENTITY, userEntity).sendToTarget();
    ...
    protected void setTitle() {
        tvTitle.setText(getResources().getString(R.string.text_scan_qr));
    }
