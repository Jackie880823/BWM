...
package com.bondwithme.BondWithMe.qr_code.zxing.encode;
...
final class MECARDContactEncoder extends ContactEncoder {
  ...
  public String[] encode(List<String> names,
    ...
    Formatter fieldFormatter = (Formatter) new MECARDFieldFormatter();

    appendUpToUnique(newContents, newDisplayContents, "N", names, 1, (Formatter) new
    ...
    appendUpToUnique(newContents, newDisplayContents, "TEL", phones, Integer.MAX_VALUE,
            (Formatter) new MECARDTelDisplayFormatter(), fieldFormatter, TERMINATOR);
