...
public class MailSender {
    ...
    public boolean sendTextMail(MailSenderModel mailInfo) {
        ...
        try {
            ...
            mailMessage.setContent(getMultipart(mailInfo.getAttachFileNames(),mailContent));
    ...
    private Multipart getMultipart(String[] filePaths,String mailContent) throws MessagingException {
