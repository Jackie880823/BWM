...
import com.bondwithme.BondWithMe.adapter.LetterBaseAdapter;
...
public class LetterListView extends FrameLayout
{
    ...
    /**
     * ������Ϣ {@link com.bondwithme.BondWithMe.widget.LetterListView.LetterHandler#handleMessage(android.os.Message)}
     *
     * @param msg ��Ϣ
     * @Description:
     * @Author Justlcw
    ...
    {
        /** ������ {@link com.bondwithme.BondWithMe.widget.LetterListView} **/
        private SoftReference<LetterListView> srLetterListView;
        
        /**
         * ���췽��
         * @param letterListView {@link com.bondwithme.BondWithMe.widget.LetterListView}
         */
