...
import com.madxstudio.co8.receiver_service.AlarmControler;
...
import com.madxstudio.co8.util.PushApi;
...
//                    if(("" + AppInfoUtil.getAppVersionCode(context)).equals(object.get("app_latest_version")) && object.get("app_major_update").equals("1")) {
    ...
    private static void showUpdateDialog(final Activity content) {
        ...
        if (updateDialog == null) {
            ...
            updateDialog.setButtonCancel(R.string.text_dialog_cancel, new View.OnClickListener() {
                @Override
