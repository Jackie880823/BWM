    ...
    public void initView() {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkall())
                {
                    StringRequest stringRequestPost = new StringRequest(Request.Method.POST, Constant.API_CREATE_NEW_USER, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                             ...
                             * begin QK
                             */
                            Toast.makeText(InformationUsernameActivity.this, getResources().getString(R.string.text_sign_up_success), Toast.LENGTH_SHORT).show();
                            /**
                             * end
                             */
                            try {
                ...
                {
                    Toast.makeText(InformationUsernameActivity.this, getResources().getString(R.string.text_choose_gender), Toast.LENGTH_SHORT).show();
                }
                else if (!cbAgree.isChecked())
                {
                    Toast.makeText(InformationUsernameActivity.this, getResources().getString(R.string.text_agree_with_terms), Toast.LENGTH_SHORT).show();
                }
                else
                {
